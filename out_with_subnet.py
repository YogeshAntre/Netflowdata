...
import pandas as pd
import json
def outgoing_func_with_subnet(gte,lte,device,interface,report,subnet):
        #print('********Subnet*********')
        ...
        #[final_graph_list_values] if final_graph_list_values["appname"] in ip_sub  else []
        ...
        # print(others_graph_list)
        # data=dict(list_values = top_10_apps_list, graph_list_values  = top_10_graph_list1)
        # df = pd.DataFrame(data)
        # df.to_excel('top_source_outgoing_10_13_0.xlsx', index=False)
